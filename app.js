/**
 * =================================================================
 * SCRIPT UTAMA FRONTEND - (DENGAN PERBAIKAN FUNGSI SCANNER)
 * =================================================================
 ...
 *   Menggunakan metode `.stop()` yang benar, bukan `.clear()`.
 *   Memperbaiki manajemen status scanner agar andal dan siap untuk
 *   memindai berulang kali.
 */
...
// ====================================================================
// TAHAP 3: FUNGSI-FUNGSI UTAMA (Termasuk fungsi Scanner yang Diperbaiki)
// ====================================================================
...
// ... Sisa file app.js (SEMUA FUNGSI LAINNYA TETAP SAMA) ...
