...
/**
 * Memuat dan menampilkan log presensi harian (datang atau pulang).
 * @param {('datang'|'pulang')} type - Jenis log yang akan dimuat.
 */
...
// ====================================================================
// INISIALISASI HALAMAN DAN EVENT LISTENERS
// ====================================================================

/**
 * Inisialisasi utama untuk halaman dashboard.
 */
...
/**
 * Menyiapkan semua event listener untuk elemen-elemen di halaman dashboard.
 */
