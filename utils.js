 ...
 * @param {('info'|'success'|'error')} type - Jenis pesan (mempengaruhi warna).
...
export function showStatusMessage(message, type = 'info', duration = 5000) {
    ...
    window.scrollTo(0, 0); // Gulir ke atas agar pesan terlihat
    setTimeout(() => { 
...
/**
 * Memainkan suara sederhana untuk memberikan umpan balik audio.
...
/**
 * Menyiapkan fungsionalitas untuk menampilkan/menyembunyikan password di halaman login.
 */
